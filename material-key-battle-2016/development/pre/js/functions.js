...
if ($(".st-social-desktop").length > 0) {
    $(".st-social-desktop img:nth(0),.st-social-mobile img:nth(0)").on("click", function(e) {
        // code share facebook
        e.preventDefault();
        var image = 'http://graphics.straitstimes.com/STI/STIMEDIA/facebook_images/budget-glance/budget-glance.png';
        var name = "Budget 2016: Key announcements at a glance";
        var description = "Find out what are the key Budget announcements and how they may affect you and your family. http://str.sg/ZF94";
        var url = "http://str.sg/ZF94";
    ...
    $(".st-social-desktop img:nth(1),.st-social-mobile img:nth(1)").on("click", function(e) {
        // code share twitter
        e.preventDefault();
        var text = "How will the %23sgbudget2016 affect you? Find out here";
        var via = 'STcom';
        var url = 'http://str.sg/ZF94';
...
var a_st_scene_menu = [];
var noscroll=0;
if ($(".chapter-division").length > 0 && typeof(ScrollMagic) !== "undefined" && noscroll===1) {
