...
(function(E, X) { typeof module === "object" && module.exports ? module.exports = E.document ? X(E) : X : E.Highcharts = X(E) })(typeof window !== "undefined" ? window : this, function(E) {
    ...
    N = {
        ...
        plotOptions: {
            line: {
                ...
                dataLabels: {
                    ...
                    style: { color: "contrast", fontSize: "14px",  textShadow: "0 0 6px contrast, 0 0 3px contrast" },
        ...
        loading: { labelStyle: {  position: "relative", top: "45%" }, style: { position: "absolute", backgroundColor: "white", opacity: 0.5, textAlign: "center" } },
        tooltip: {
            enabled: !0,
            animation: ca,
            ...
            shadow: !0,
            snap: Mb ? 25 : 10,
            style: { color: "#333333", cursor: "default", fontSize: "14px", padding: "8px", pointerEvents: "none", whiteSpace: "nowrap" }
        },
        credits: {
            enabled: !0,
            text: "Highcharts.com",
        ...
        getBBox: function(a, b) {
            ...
            if (!c) {
                ...
                if (d.isSVG) { d = c.width;
                    e = c.height;
                    if (ya && i && i.fontSize === "13px" && e.toPrecision(3) === "16.9") c.height = e = 14;
    ...
    Ca.prototype = {
        ...
        getStyle: function(a) {
            return this.style = u({ fontFamily: '"Curator Regular", "Lucida Sans Unicode", Arial, Helvetica, sans-serif', fontSize: "14px" }, a) },
        isHidden: function() {
        ...
        buildText: function(a) {
            ...
            !f && !n && !r && e.indexOf(" ") === -1 ? b.appendChild(y.createTextNode(x(e))) : (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/, R && R.appendChild(b), e = f ? e.replace(/<(b|strong)>/g, '<span style="font-weight:normal">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g) : [e], e[e.length - 1] ===
    ...
    ka.prototype = {
        defaultOptions: {
            ...
            labels: { enabled: !0, style: { color: "#606060", cursor: "default", fontSize: "13px" }, x: 0, y: 15 },
            lineColor: "#C0D0E0",
            lineWidth: 1,
            minPadding: 0.01,
            maxPadding: 0.01,
